  ...
  <div class="app-container">
    ...
    <div class="crs-container">
      ...
      <div class="img5-container clearfix">
        <div class="title-common">JAC Makes Contribution by Offering Assistance Proactively</div>
      ...
      <div class="img6-container clearfix">
        <div class="title-common">Fight against Epidemic with Concrete Actions</div>
        <div class="img pull-left">
          <img src="@assets/img/crs/img6.png">
        </div>
        <div class="text pull-right">
          <p>On January 30, in a response to the requisition of Hefei Emergency</p>
          ...
          <p>At the same time, a "Caring Vanguard" charity fleet was established to</p>
          <p>provide free rescue services for anti-epidemic vehicles as well other</p>
          <p>vehicles during the epidemic. Simultaneously, JAC Charity Fleet ac-</p>
          <p>tively coordinated with the government to deliver KN95 masks, infra-</p>
          <p>red thermometers, disinfectant, etc. for the prevention of epidemic in</p>
      ...
      <div class="img9-container clearfix">
        ...
        <div class="text text2 pull-right">
          ...
          <p>At this difficult moment, we should stay at home and keep confidence.</p>
          <p>This world has hope and surprise anywhere. JAC Peru truck club will</p>
        ...
        <div class="text text6 pull-left">
          ...
          <p>us.JAC initiates the activity of 'Cherish and Join' on social plat-</p>
